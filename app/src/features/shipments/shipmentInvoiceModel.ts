...
export function isCrossBilled(invoice: ShipmentInvoiceDto, line: ShipmentInvoiceLineDto): boolean {
...
export function partOrigin(invoice: ShipmentInvoiceDto, line: ShipmentInvoiceLineDto): string {
...
export function originChips(invoice: ShipmentInvoiceDto, group: LineGroup): OriginChips {
...
export function moveTargetOptions(
  ...
  fromInvoice: ShipmentInvoiceDto,
  group: LineGroup,
): MoveTargetOption[] {
  ...
  for (const [clientId, invoices] of byClient) {
    ...
    for (const invoice of sorted) {
      if (invoice.id === fromInvoice.id) continue;
      out.push({
