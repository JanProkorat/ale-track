...
public sealed class UpdateOutgoingShipmentTests
{
    ...
    public async Task ProcessAsync_UpdateOutgoingShipment_Success()
    {
        ...
        var endpoint = EndpointBuilder<UpdateOutgoingShipmentRequest, UpdateOutgoingShipmentEndpoint>.Create(dbContext.Object, Options.Create(new CompanyOptions()), DriverScopeMockFactory.Unscoped(), AppContextMockFactory.Anonymous());
    ...
    public async Task ProcessAsync_ChangeContentOfLoadedShipment_Fails()
    {
        ...
        var endpoint = EndpointBuilder<UpdateOutgoingShipmentRequest, UpdateOutgoingShipmentEndpoint>.Create(db.Object, Options.Create(new CompanyOptions()), DriverScopeMockFactory.Unscoped(), AppContextMockFactory.Anonymous());
